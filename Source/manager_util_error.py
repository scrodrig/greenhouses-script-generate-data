...
def group_by_hours_temperature_error(path, input_file, minutes, time_behind_hours, training_percentage):
    ...
    training_data.to_csv(path + 'grouped-no-gaps-temperature-range-results_training.csv', index=False, header=False)
    test_data.to_csv(path + 'grouped-no-gaps-temperature-range-results_test.csv', index=False, header=False)
...
def group_by_hours_environment_humidity_error(path, input_file, minutes, time_behind_hours, training_percentage):
    ...
    training_data.to_csv(path + 'grouped-no-gaps-environment-humidity-range-results_training.csv', index=False,
                         header=False)
    test_data.to_csv(path + 'grouped-no-gaps-environment-humidity-range-results_test.csv', index=False, header=False)
