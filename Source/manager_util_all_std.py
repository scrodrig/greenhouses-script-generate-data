...
def group_by_hours_all_std(path):
...
def group_by_hours_temperature_all_parameters(path):
    df_temp = pd.read_csv(path + 'grouped-no-gaps-temperature-range-results_training_std.csv')
    df_eh = pd.read_csv(path + 'grouped-no-gaps-environment-humidity-range-results_training_std.csv')
    df_gh = pd.read_csv(path + 'grouped-no-gaps-ground-humidity-range-results_training_std.csv')
    df_lum = pd.read_csv(path + 'grouped-no-gaps-luminosity-range-results_training_std.csv')
    ...
    result_2.to_csv(path + 'temperature-parameter_training_std.csv', index=False, header=True)


def group_by_hours_temperature_all_parameters_test(path):
    df_temp = pd.read_csv(path + 'grouped-no-gaps-temperature-range-results_test_std.csv')
    df_eh = pd.read_csv(path + 'grouped-no-gaps-environment-humidity-range-results_test_std.csv')
    df_gh = pd.read_csv(path + 'grouped-no-gaps-ground-humidity-range-results_test_std.csv')
    df_lum = pd.read_csv(path + 'grouped-no-gaps-luminosity-range-results_test_std.csv')
    ...
    result_2 = pd.concat([df_eh, df_gh, df_lum, df_temp], axis=1)
    result_2.to_csv(path + 'temperature-parameter_test_std.csv', index=False, header=True)
...
def group_by_hours_environment_humidity_all_parameters(path):
    ...
    result_2.to_csv(path + 'environment-humidity-parameter_training_std.csv', index=False, header=True)
...
def group_by_hours_environment_humidity_all_parameters_test(path):
    ...
    result_2 = pd.concat([df_temp, df_gh, df_lum, df_eh], axis=1)
    result_2.to_csv(path + 'environment-humidity-parameter_test_std.csv', index=False, header=True)
...
def group_by_hours_ground_humidity_all_parameters(path):
    ...
    result_2.to_csv(path + 'ground-humidity-parameter_training_std.csv', index=False, header=True)
...
def group_by_hours_ground_humidity_all_parameters_test(path):
    ...
    result_2 = pd.concat([df_temp, df_eh, df_lum, df_gh], axis=1)
    result_2.to_csv(path + 'ground-humidity-parameter_test_std.csv', index=False, header=True)
...
def group_by_hours_luminosity_all_parameters(path):
    ...
    result_2.to_csv(path + 'luminosity-parameter_training_std.csv', index=False, header=True)
...
def group_by_hours_luminosity_all_parameters_test(path):
    ...
    result_2 = pd.concat([df_temp, df_eh, df_gh, df_lum], axis=1)
    result_2.to_csv(path + 'luminosity-parameter_test_std.csv', index=False, header=True)
